...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.coursesList.setGeometry(QtCore.QRect(20, 220, 411, 151))
        ...
        self.progressBar.setGeometry(QtCore.QRect(100, 380, 331, 23))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.progressInfo = QtWidgets.QTextBrowser(Dialog)
        self.progressInfo.setGeometry(QtCore.QRect(20, 440, 411, 71))
        self.progressInfo.setObjectName("progressInfo")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(24, 397, 59, 16))
        self.label_3.setObjectName("label_3")
        self.subProgressBar = QtWidgets.QProgressBar(Dialog)
        self.subProgressBar.setGeometry(QtCore.QRect(100, 410, 331, 23))
